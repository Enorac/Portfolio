...
def test_get_region_from_state():
    ...
    state_df = pd.read_csv("/home/codio/workspace/code/data/statemappings.csv")
...
def test_add_columns():
    ...
    df = pd.read_csv("/home/codio/workspace/code/data/politicaldata.csv")
    state_df = pd.read_csv("/home/codio/workspace/code/data/statemappings.csv")
...
def test_all():
    ...
    df = pd.read_csv("/home/codio/workspace/code/data/politicaldata.csv")
    add_columns(df, pd.read_csv("/home/codio/workspace/code/data/statemappings.csv"))
